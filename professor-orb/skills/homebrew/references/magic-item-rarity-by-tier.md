...
This table represents the expected total number of permanent magic items distributed across an average campaign at each tier. Use it as a reference point when assessing whether a homebrew item's rarity is appropriate for when it would realistically appear.

---

## Levels 1–4 (Tier 1)

| Rarity    | Expected Items |
|-----------|---------------|
| Common    | 6             |
| Uncommon  | 4             |
| Rare      | 1             |
