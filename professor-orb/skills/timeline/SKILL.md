...
- **Where chronology documents live.** They live in the resolved setting's `kbRoot`, per SHARED-PRINCIPLES Principle 12. An existing `type: chronology` value marks an article written before the migration to the canonical layout.
