...
**Standalone, on demand, never part of pipeline state:** setup (after the first install), homebrew, timeline, `/catalog`, `/scribe`, `/log`, `/migrate`, the validation-sweep workflow, and orb itself.
